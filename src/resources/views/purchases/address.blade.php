...
@section('content')
    <div class="content-wrapper">
        ...
        <form class="content-form-form" action="{{ url('/purchase/address/' . $itemId) }}" method="post">
            ...
            <input class="content-form-input" type="text" name="postal_code" id="postal_code" value="{{ old('postal_code') }}">
            ...
            <input class="content-form-input" type="text" name="address" id="address" value="{{ old('address') }}">
            <p class="content-form-error-message">
                @error('address')
                    {{ $message }}
                @enderror
            ...
            <input class="content-form-input" type="text" name="building" id="building" value="{{ old('building') }}">
            <p class="content-form-error-message">
                @error('building')
                    {{ $message }}
                @enderror
